...
enum class Sprite : int
{
  SPRITE_NONE = -1,
  SPRITE_VINE = 0,
  SPRITE_HANGING_LEAVES = 1,
  SPRITE_HIDDEN_BLOCK = 2,
  SPRITE_CANDLE = 3,
  SPRITE_VINE_LOOP = 4,
  SPRITE_HANGING_FLOWER = 5,
  ...
  SPRITE_FALLING_ROCK = 16,
  SPRITE_HANGING_PLATFORM_CABLE_1 = 17,
  SPRITE_HANGING_PLATFORM_CABLE_2 = 18,
  SPRITE_ROCKS_1 = 20,
  SPRITE_ROCKS_2 = 21,
  SPRITE_ROCKS_3 = 24,
  SPRITE_ROCKS_4 = 25,
  SPRITE_EXPLOSION_1 = 28,
  SPRITE_EXPLOSION_2 = 29,
  SPRITE_EXPLOSION_3 = 30,
  SPRITE_EXPLOSION_4 = 31,
  SPRITE_BIG_CHAIN = 34,
  SPRITE_BLUE_TILE_1 = 44,
  SPRITE_TENTACLE_WALK_L_1 = 52,
  SPRITE_TENTACLE_PAUSE_1 = 68,
  SPRITE_TENTACLE_SLIME = 75,
  SPRITE_TENTACLE_WALK_R_1 = 76,
  SPRITE_HANGING_PLATFORM_1 = 92,
  SPRITE_HANGING_PLATFORM_2 = 93,
  SPRITE_HANGING_PLATFORM_HOIST_1 = 94,
  SPRITE_HANGING_PLATFORM_HOIST_2 = 95,
  SPRITE_MINE_CART_1 = 98,
  ...
  SPRITE_ROCKMAN_R_1 = 116,
  SPRITE_SPIDER_DOWN_1 = 128,
  SPRITE_SPIDER_UP_1 = 136,
  SPRITE_RED_CRATE_1 = 144,
  SPRITE_RED_CRATE_2 = 145,
  SPRITE_FALLING_ROCKS_1 = 146,
  SPRITE_FALLING_ROCKS_2 = 147,
  SPRITE_SPIDER_WEB = 150,
  SPRITE_AIR_PIPE_R_1 = 156,
  SPRITE_AIR_PIPE_L_1 = 158,
  SPRITE_SNAKE_WALK_L_1 = 160,
  SPRITE_SNAKE_PAUSE_1 = 169,
  SPRITE_SNAKE_WALK_R_1 = 176,
  SPRITE_AIR_L_1 = 185,
  SPRITE_STALAGMITE_1 = 188,
  SPRITE_STALAGMITE_2 = 189,
  SPRITE_STALACTITE_1 = 190,
  SPRITE_STALACTITE_2 = 191,
  SPRITE_METAL_CRATE_UL = 192,
  SPRITE_METAL_CRATE_UR = 193,
  SPRITE_METAL_CRATE_DL = 194,
  SPRITE_METAL_CRATE_DR = 195,
  SPRITE_AIR_R_1 = 200,
  SPRITE_SNAKE_SLIME = 204,
  SPRITE_BIRD_EGG_OPEN = 208,
  SPRITE_BIRD_1 = 209,
  SPRITE_HORIZON = 219,
  SPRITE_BAT_1 = 220,
  ...
  SPRITE_BIRDLET_1 = 253,
  SPRITE_STANDING_RIGHT = 260,
  SPRITE_MISSILE_POWER_R_1 = 288,
  SPRITE_MISSILE_POWER_L_1 = 292,
  SPRITE_MISSILE_R_1 = 296,
  SPRITE_MISSILE_L_1 = 302,
  SPRITE_PISTOL = 308,
  SPRITE_POWER = 309,
  SPRITE_OSTRICH_L_1 = 312,
  SPRITE_OSTRICH_R_1 = 324,
  SPRITE_IMPLOSION_1 = 336,
  SPRITE_IMPLOSION_2 = 337,
  SPRITE_IMPLOSION_3 = 338,
  SPRITE_IMPLOSION_4 = 339,
  SPRITE_IMPLOSION_5 = 340,
  SPRITE_IMPLOSION_6 = 341,
  SPRITE_IMPLOSION_7 = 342,
  SPRITE_IMPLOSION_8 = 343,
  SPRITE_IMPLOSION_9 = 344,
  SPRITE_BULLET = 345,
  SPRITE_HAZARD_CRATE_UL = 348,
  SPRITE_HAZARD_CRATE_UR = 349,
  SPRITE_HAZARD_CRATE_DL = 352,
  SPRITE_HAZARD_CRATE_DR = 353,
  SPRITE_STARS_1 = 356,
  SPRITE_STARS_2 = 357,
  SPRITE_STARS_3 = 358,
  SPRITE_STARS_4 = 359,
  ...
  SPRITE_STARS_6 = 361,
  SPRITE_COLUMN = 400,
  SPRITE_COLUMN_HEAD = 401,
  SPRITE_COLUMN_HEAD_L = 402,
  SPRITE_COLUMN_HEAD_R = 403,
  SPRITE_PIPE_V = 408,
  SPRITE_PIPE_H = 409,
  SPRITE_PIPE_UR = 410,
  SPRITE_PIPE_UL = 411,
  ...
  SPRITE_SMALL_CHAINS = 438,
  SPRITE_SMALL_CHAINS_END = 439,
  ...
  SPRITE_FLAME_3 = 487,
  SPRITE_FLAME_4 = 488,
  SPRITE_HAMMER_RAIL_1 = 492,
  SPRITE_HAMMER_RAIL_2 = 493,
  SPRITE_HOPPER_1 = 496,
  ...
  SPRITE_PLANET_UL = 530,
  SPRITE_PLANET_UR = 531,
  SPRITE_GREY_STONE_3 = 532,
  SPRITE_GREY_STONE_4 = 533,
  SPRITE_PLANET_DL = 534,
  SPRITE_PLANET_DR = 535,
  SPRITE_SPACESHIP_1 = 536,
  SPRITE_SPACESHIP_2 = 537,
  SPRITE_SPACESHIP_3 = 538,
  SPRITE_SPACESHIP_4 = 539,
  SPRITE_SPACESHIP_5 = 540,
  SPRITE_TRADING_POST_1 = 544,
  SPRITE_TRADING_POST_2 = 545,
  SPRITE_TRADING_PLANET_1 = 546,
  SPRITE_TRADING_PLANET_2 = 547,
  ...
  SPRITE_GPIPE_DT = 566,
  SPRITE_GPIPE_UT = 567,
  SPRITE_MINE_PIPE = 568,
  SPRITE_BARREL = 575,
  SPRITE_HOLE_PIPE_V = 576,
  SPRITE_METER = 579,
  SPRITE_HOLE_PIPE_H = 580,
  SPRITE_LASER_R = 581,
  SPRITE_LASER_L = 582,
  ...
  SPRITE_ROCKY_PLATFORM_L = 628,
  SPRITE_ROCKY_PLATFORM_MID = 629,
  SPRITE_ROCKY_PLATFORM_R = 630,
  SPRITE_EARTH = 632,
  SPRITE_MOON = 633,
  ...
  SPRITE_BONES_PARTICLE_1 = 640,
  SPRITE_BONES_PARTICLE_2 = 641,
  SPRITE_BONES_PARTICLE_3 = 642,
  SPRITE_BONES_PARTICLE_4 = 643,
  SPRITE_BONES_PARTICLE_5 = 644,
  SPRITE_BONES_PARTICLE_6 = 645,
  SPRITE_BONES_PARTICLE_7 = 646,
  SPRITE_BONES_PARTICLE_8 = 647,
  SPRITE_BONES_PARTICLE_9 = 648,
  SPRITE_BONES_PARTICLE_10 = 649,
  SPRITE_BONES_PARTICLE_11 = 650,
  SPRITE_BONES_PARTICLE_12 = 651,
  SPRITE_BONES_PARTICLE_13 = 652,
  SPRITE_CEILING_MOSS_1 = 653,
  SPRITE_CEILING_MOSS_2 = 654,
  ...
  SPRITE_EGG = 670,
  SPRITE_CHEST_OPEN = 671,
  SPRITE_MUSHROOM_BLUE = 672,
  SPRITE_CHEST_CLOSED = 673,
  SPRITE_FAUCET_1 = 676,
  SPRITE_DROPLET_1 = 684,
  SPRITE_DROPLET_2 = 685,
  SPRITE_ROBOT_R_1 = 688,
  SPRITE_ROBOT_L_1 = 692,
  SPRITE_ROBOT_ZAP_R = 696,
  SPRITE_ROBOT_ZAP_L = 697,
  SPRITE_LASER_BEAM_1 = 698,
  SPRITE_LASER_BEAM_2 = 699,
  SPRITE_STOP_SIGN = 700,
  SPRITE_STOP_POLE = 701,
  SPRITE_WALL_MONSTER_R_1 = 703,
  ...
  SPRITE_GRILLE_3 = 732,
  SPRITE_GRILLE_4 = 733,
  SPRITE_CATERPILLAR_L_HEAD_1 = 764,
  SPRITE_CATERPILLAR_L_BODY_1 = 766,
  SPRITE_CATERPILLAR_L_TAIL_1 = 768,
  SPRITE_BRICK_1 = 780,
  SPRITE_BRICK_2 = 781,
  ...
  SPRITE_500 = 828,
  SPRITE_PLAYER_EXPLODE_1 = 849,
  SPRITE_PLAYER_EXPLODE_2 = 850,
  SPRITE_PLAYER_EXPLODE_3 = 851,
  SPRITE_PLAYER_HAT = 852,
  SPRITE_TRICERATOPS_HEAD_L_1 = 856,
  SPRITE_TRICERATOPS_TAIL_R_1 = 876,
  SPRITE_TRICERATOPS_SHOT_1 = 880,
  SPRITE_STAND_MIXER_TOP_1 = 884,
  SPRITE_STAND_MIXER_TOP_2 = 885,
  SPRITE_WOOD_STRUT_1 = 886,
  SPRITE_WOOD_STRUT_2 = 887,
  SPRITE_STAND_MIXER_BOTTOM_1 = 888,
  SPRITE_STAND_MIXER_BOTTOM_2 = 889,
  SPRITE_WOOD_PILLAR_1 = 890,
  SPRITE_WOOD_PILLAR_2 = 891,
  SPRITE_SECTOR_ALPHA_SIGN_TOP_1 = 892,
  SPRITE_SECTOR_ALPHA_SIGN_TOP_2 = 893,
  SPRITE_AIR_TANK_TOP_1 = 894,
  SPRITE_AIR_TANK_TOP_2 = 895,
  SPRITE_SECTOR_ALPHA_SIGN_BOTTOM_1 = 896,
  SPRITE_SECTOR_ALPHA_SIGN_BOTTOM_2 = 897,
  SPRITE_AIR_TANK_BOTTOM = 898,
  SPRITE_100 = 899,
  SPRITE_GLASS_BALL_1 = 900,
  SPRITE_GLASS_BALL_2 = 901,
  SPRITE_200 = 902,
  SPRITE_400 = 903,
  SPRITE_GLASS_BALL_3 = 904,
  SPRITE_GLASS_BALL_4 = 905,
  SPRITE_800 = 906,
  SPRITE_1000 = 907,
  SPRITE_2000 = 910,
  SPRITE_5000 = 911,
  ...
  SPRITE_EYE_MONSTER_BODY_1 = 1040,
  SPRITE_EYE_MONSTER_EYE_CLOSING_L_1 = 1044,
  SPRITE_EYE_MONSTER_EYE_OPEN_L_1 = 1048,
  SPRITE_EYE_MONSTER_EYE_CLOSING_R_1 = 1052,
  SPRITE_EYE_MONSTER_EYE_OPEN_R_1 = 1056,
  SPRITE_EYE_MONSTER_EYE_STUB_L_1 = 1060,
  SPRITE_EYE_MONSTER_EYE_STUB_R_1 = 1064,
  SPRITE_EYEBALL_L_1 = 1068,
  SPRITE_EYEBALL_R_1 = 1072,
  SPRITE_SNOOZER_R_1 = 1076,
  SPRITE_SNOOZER_L_1 = 1080,
  SPRITE_SNOOZER_SLEEP = 1084,
  SPRITE_SNOOZER_Z_1 = 1085,
  SPRITE_BLUE_BALL = 1089,
  SPRITE_CONCRETE = 1092,
  SPRITE_CONCRETE_H = 1093,
  SPRITE_CONCRETE_V = 1094,
  SPRITE_CONCRETE_X = 1095,
  SPRITE_PIPE_TOP_L = 1096,
  SPRITE_PIPE_TOP_R = 1097,
  SPRITE_GRASS = 1098,
  SPRITE_PIPE_L = 1100,
  SPRITE_PIPE_R = 1101,
